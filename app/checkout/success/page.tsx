...
export default function SuccessPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <Suspense fallback={
        <div className="max-w-2xl mx-auto px-4 py-24 text-center">
          <div className="w-24 h-24 bg-accent rounded-full mx-auto mb-6 animate-pulse" />
          <div className="h-8 bg-accent rounded-xl mx-auto w-64 mb-4 animate-pulse" />
          <div className="h-4 bg-accent rounded-xl mx-auto w-48 animate-pulse" />
        </div>
      }>
        <SuccessContent />
      </Suspense>
